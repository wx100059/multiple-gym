...
class DDPG(OffPolicyRLModel):
    ...
    def setup_model(self):
        with SetVerbosity(self.verbose):
            ...
            with self.graph.as_default():
                ...
                replay_buffer_fn = replay_buffers.get_replay_buffer("multi_timescale")
                self.replay_buffer_params = {'size': 1000, 'num_buffers': 20, 'beta': 0.85, 'no_waste': True}
    ...
    def _train_step(self, step, writer, log=False):
        ...
        obs, actions, rewards, next_obs, terminals = self.replay_buffer.sample(self.batch_size)
